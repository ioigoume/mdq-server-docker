...
# entity descriptor.
# If you do not pass any argument to this script, the GRNET idp's entityID
# is used as default identifier.
#
# Note: set environment variable MDQ_BASE_URL before using this script
# if you don't want to use the default url 'mdq-test.demo.rciam.grnet.gr'.
#
# Example:
#
...
MDQ_BASE_URL=${MDQ_BASE_URL:-mdq-test.demo.rciam.grnet.gr}
IDENTIFIER=${IDENTIFIER:-https://idp.aai-dev.grnet.gr/idp/shibboleth}
